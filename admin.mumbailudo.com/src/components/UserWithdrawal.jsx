...
function  UserWithdrawal({userid}) {
  ...
  async function fetchData() {
    setLoading(true);
    try {
        const result = await axios.get(`${baseUrl}/admin/dashboard/view/transaction/history?request_type=${requestType}&page=${currentPage}&limit=${itemsPerPage}&status=${selectedFilter}&userId=${userid}`, {
            headers: {
