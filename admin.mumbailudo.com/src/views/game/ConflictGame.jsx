...
function ConflictGame() {
  ...
  const [requestType, setRequestType] = useState("conflict")
      ...
      <table className="w-full rounded-xl">
                    ...
                    </thead>
                    {
                      data?.map((item, index) => (
                        ...
                        >
                            <td className="p-2whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                {startIndex + index + 1}
                            </td>
                            <td className="p-2whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                            ...
                            <td className="p-2capitalize whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                {"₹ "}{item.game_amount}
                            </td>
                            <td className="p-2whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                {item.room_code?? "N/A"}
